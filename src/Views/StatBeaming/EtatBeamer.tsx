    ...
    return(
        <div className='divContainer'>
            <div className='mainHeader'>
                ...
                width={'100%'}>
				<ColumnsDirective>
					<ColumnDirective field='beamerName' headerText='Beamer' width='100' textAlign='Center' />
					<ColumnDirective
						field='totalTimeOn'
					...
					/>
					<ColumnDirective
						field='nbrCounterStop'
						headerText='Nbr arrêts compteur'
						width='100'
						textAlign='Center'
					/>
					<ColumnDirective field='nbrBtnStop' headerText='Nbr arrêts stop' width='100' textAlign='Center' />
					<ColumnDirective field='nbrEstop' headerText='Nbr arrêts E-stop' width='100' textAlign='Center' />
					<ColumnDirective
						field='nbrYarnBreak'
						headerText='Nbr arrêts Casse-fil'
						width='100'
						textAlign='Center'
					/>
				</ColumnsDirective>
